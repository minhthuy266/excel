...
export const TableContent = () => {
  ...
  const columns = [
    ...
    },
    {
      title: (
        <div>
          <div>{t("tableContent.column.handler")}</div>
          <div>{t("tableContent.column.handleDate")}</div>
        </div>
      ),
    ...
    },
    {
      title: (
        <div>
          <div>{t("tableContent.column.manager")}</div>
          <div>{t("tableContent.column.managementDate")}</div>
        </div>
      ),
    ...
    {
      title: `${t("tableContent.column.tool")}`,
      dataIndex: "contract",
      render: (text, row) => (
        <div>
  ...
  return (
    <TableContentWrapper>
      <Table columns={columns} dataSource={data} bordered title={() => "BOM"} />
    </TableContentWrapper>
  );
};
