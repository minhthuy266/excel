...
const poAdapter = createEntityAdapter({});

const initialState = poAdapter.getInitialState();
...
export const selectProjectsResult =
  poSlice.endpoints.getProjects.select();
...
export const {
  selectAll: selectAllpo,
  selectById: selectUserById,
  selectIds: selectUserIds,

  //   Pass in a selector that returns the po slice of state
} = poAdapter.getSelectors(
